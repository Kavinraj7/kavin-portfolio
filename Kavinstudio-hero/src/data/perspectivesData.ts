...
export const PERSPECTIVES_DATA: PerspectiveItem[] = [
  {
    ...
    iconName: 'Building2',
    accentColor: 'indigo',
    summary: 'Orchestrating multi-disciplinary engineering, product, and operations divisions. Specializing in high-stakes execution, multi-million dollar capital allocation, and zero-defect organizational cadence.',
    highlights: [
    ...
    caseStudies: [
      {
        ...
        description: 'Led the operational overhaul of redundant legacy contracts, consolidated tracking systems, and authored global compliance SLAs for cross-border engineering delivery.',
      ...
      },
      {
        ...
        description: 'Assumed interim command over a slipping core release. Restructured standups, pruned non-critical dependencies, and mobilized 24/7 tiger teams to hit deadline 3 days early.',
  ...
  },
  {
    ...
    iconName: 'Users',
    accentColor: 'emerald',
    summary: 'Engineering cultural resilience, high-conviction hiring bars, and human-centric feedback loops. Bridging technical engineering reality with deep emotional intelligence and career mobility pathways.',
    highlights: [
    ...
    caseStudies: [
      {
        ...
        description: 'Constructed an immersive 12-week internal academy pairing junior talent directly with senior staff on production pull requests, cutting external recruiting spend drastically.',
      ...
      },
      {
        ...
        description: 'Eliminated status check meetings in favor of asynchronous written artifacts, establishing core collaboration windows and quarterly in-person hack retreats.',
  ...
  },
  {
    ...
    iconName: 'Code2',
    accentColor: 'blue',
    summary: 'Hands-on architectural craftsmanship spanning distributed microservices, low-latency UI frameworks, edge compute, and type-safe systems. obsessed with performance, minimalism, and developer ergonomics.',
    highlights: [
    ...
    caseStudies: [
      {
        ...
        description: 'Designed an in-memory streaming pipeline utilizing Rust edge nodes, Redis streams, and typed WebSocket broadcast channels to deliver instantaneous financial dashboards.',
      ...
      },
      {
        ...
        description: 'Architected an accessible, themeable design system featuring mathematical typography scales, fluid animations, and zero-runtime CSS-in-JS overhead.',
  ...
  },
  {
    ...
    iconName: 'BarChart3',
    accentColor: 'amber',
    summary: 'Transforming murky telemetry, transactional databases, and user behavior into sharp predictive models, cohort analyses, and actionable executive dashboards that guide multi-million dollar decisions.',
    highlights: [
    ...
    caseStudies: [
      {
        ...
        description: 'Trained gradient-boosted decision trees on 120 behavioral feature vectors. Hooked inferences directly into customer success workflows via automated webhooks.',
      ...
      },
      {
        ...
        description: 'Instrumented client-side interaction events with differential privacy, normalizing high-frequency events into granular user journey maps and retention heatmaps.',
  ...
  },
  {
    ...
    iconName: 'Sparkles',
    accentColor: 'purple',
    summary: 'The intersection of engineering discipline, people leadership, operational rigor, and data-informed decision making. Built for organizations where technical depth meets strategic vision.',
    highlights: [
    ...
    caseStudies: [
      {
        ...
        description: 'Acted as principal architect and operations lead, migrating legacy architecture to modern event-driven serverless while overhauling engineering hiring and cultural rituals.',
      ...
      },
      {
        ...
        description: 'Designed agentic workflows connecting internal knowledge bases with fine-tuned LLMs, embedding guardrails and zero-leakage security protocols.',
...
export const WRITING_ARTICLES = [
  {
    ...
    excerpt: 'Engineering velocity is rarely constrained by how fast individual developers type code. It is throttled by cognitive load, ambiguous specifications, and asynchronous fear.'
  },
  {
    ...
    excerpt: 'Duplication is far cheaper than the wrong abstraction. A reflection on designing modular software systems that adapt gracefully to evolving business realities.'
  },
  {
    ...
    readTime: '5 min read',
    tags: ['TALENT', 'CAREER'],
    excerpt: 'In an era where AI lowers the barrier to entry across every domain, the highest leverage belongs to individuals who can synthesize deep engineering with business empathy.'
  }
];
...
export const BIOGRAPHY_MILESTONES = [
  {
    ...
    description: 'Leading platform engineering, enterprise operations, and bespoke AI application development. Advising early-stage founders on team topology and architectural scale.'
  },
  {
    period: '2020 — 2023',
    role: 'Head of Engineering & Technical Operations',
    organization: 'Venture-Backed Cloud Solutions',
    description: 'Grew engineering organization from 12 to 50+ members. Drove architectural evolution from legacy monolith to cloud-native microservices while maintaining 99.99% uptime.'
  },
  {
    period: '2017 — 2020',
    role: 'Senior Full-Stack & Distributed Systems Engineer',
    organization: 'FinTech & Real-Time Data Labs',
    description: 'Engineered high-frequency messaging pipelines, interactive data visualization workspaces, and fault-tolerant financial settlement services.'
  }
];
